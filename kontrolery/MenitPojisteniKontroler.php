...
/**
 * Kontroler pro editaci stavajiciho pojistneho produktu vcetne druhu (nazvu)
 */
class MenitPojisteniKontroler extends Kontroler
{
	public function zpracuj(array $parametry): void
	{
		$this->hlavicka = array(
			'titulek' => 'Aktualizovat pojištění',
		...
		if ($_POST) {
			...
			// oba datumy zohlednuji pravopisne spravny (1. 1. 2020) i nespravny format datumu (pouzity v zadani)
				...
				$_SESSION['uspech'] = 'Produkt ' . $_POST['poj_produkt'] . ' byl aktualizován.';
